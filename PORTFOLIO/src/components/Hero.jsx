  ...
  return (
    <section className="h-screen flex flex-col justify-center items-center text-center bg-gray-900">
      ...
      <div className="flex gap-4">
        <a href="/resume.pdf" className="px-4 py-2 bg-blue-600 rounded hover:bg-blue-700">Download Resume</a>
        <a href="#contact" className="px-4 py-2 border border-blue-600 rounded hover:bg-blue-600">Contact Me</a>
      </div>
    </section>
  );
};
